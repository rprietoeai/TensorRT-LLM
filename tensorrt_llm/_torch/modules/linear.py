...
class NVFP4LinearMethod(LinearMethodBase):
    ...
    def apply(self, module: Linear, input: torch.Tensor,
        ...
        if isinstance(input, Fp4QuantizedTensor):
            ...
            ramon.log(f"---|---|--->module input scale dtype: {module.input_scale.shape}")
            ramon.log(f"---|---|--->module scaling vector size: {module.scaling_vector_size}")
        ...
        if IS_CUTLASS_DSL_AVAILABLE and module.use_cute_dsl_nvfp4_blockscaling_mm:
            ...
            ramon.log("---|---|--->Right before cute dsl nvfp4 gemm for blackwell")
            ...
            ramon.log(f"---|---|--->modul dtype: {module.dtype}")
